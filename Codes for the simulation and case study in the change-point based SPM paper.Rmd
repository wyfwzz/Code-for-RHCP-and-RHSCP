##Code for simulation and case study in the "A Change-Point Based Control Chart for Detecting Sparse Changes in High-Dimensional Data"
##--------------------------------------------------------------------------------------------------------------
...
##----------------------------------------------------------------------------------------------------------------------------
##Part 2. Function for case study
...
##------------------------------------------------------------------------------------------
##Part 3. Example of applying simulation functions.
...
testCL <- Changthreshold(t(S_IC), simulation, W, (1-(1-0.01)^(1/length(step)))) #Data-driven control limits for the semiconductor data
tau = 10
result <- case_performance(W, tau, simulation, testCL)

##-----------------------------------------------------------------------------------------------------------------------------------------
##Part 5. Figures in the paper
